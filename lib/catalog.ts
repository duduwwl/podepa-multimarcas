...
export const catalog: CatalogProduct[] = [
  ...
  { id:"kit-nike-blue-street", sku:"KIT-BLU-01", name:"Kit Blue Street", category:"Kits", price:389.9, compareAt:449.7, images:["/products/kit-01-blue-street.png"], badge:"Kit 01", sizes:["M / 38","G / 39","GG / 40"], initialStock:5, description:"Camiseta azul oversized, bermuda preta e tênis branco para um visual street completo." },
  { id:"kit-adidas-chocolate", sku:"KIT-CHO-02", name:"Kit Originals Chocolate", category:"Kits", price:419.9, compareAt:479.7, images:["/products/kit-02-originals-chocolate.png"], badge:"Kit 02", sizes:["M / 38","G / 39","GG / 40"], initialStock:4, description:"Camiseta chocolate, bermuda branca e tênis branco com contraste preto." },
  { id:"kit-air-sand", sku:"KIT-SND-03", name:"Kit Air Sand", category:"Kits", price:399.9, compareAt:459.7, images:["/products/kit-03-air-sand.png"], badge:"Kit 03", sizes:["M / 38","G / 40","GG / 42"], initialStock:4, description:"Camiseta areia, bermuda jeans preta destroyed e tênis branco com detalhe preto." },
  { id:"kit-air-blue", sku:"KIT-AIR-04", name:"Kit Air Blue", category:"Kits", price:429.9, compareAt:489.7, images:["/products/kit-04-air-blue.png"], badge:"Kit 04", sizes:["M / 38","G / 39","GG / 40"], initialStock:4, description:"Camiseta e bermuda pretas combinadas com tênis azul-claro para destacar o look." },
