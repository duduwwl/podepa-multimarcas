...
export default function Storefront({ mode = "home" }: { mode?: "home" | "catalog" } = {}) {
  ...
  async function placeOrder(event:FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const body = { name:form.get("name"), email:form.get("email"), phone:form.get("phone"), cpf:form.get("cpf"), cep:deliveryMethod === "delivery" ? form.get("cep") : "", address, city:deliveryMethod === "delivery" ? form.get("city") : "", state:deliveryMethod === "delivery" ? form.get("state") : "", deliveryMethod, paymentMethod, items:cart };
  ...
  return <main>
    <header className="nav-shell">
      ...
      <a className="brand header-brand" href="/" aria-label="Pode Pá Multimarcas, início"><span>Pode <img className="brand-inline-mark" src="/podepa-peace-mark.png" alt=""/> Pá</span><small>MULTIMARCAS</small></a>
