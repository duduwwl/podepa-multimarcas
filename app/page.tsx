...
export default function Storefront({ mode = "home" }: { mode?: "home" | "catalog" } = {}) {
  ...
  return <main>
    <header className="nav-shell">
      ...
      <a className="brand header-brand" href="/" aria-label="Pode Pá Multimarcas, início"><img className="brand-top-mark" src="/podepa-peace-mark.png" alt=""/><span>Pode Pá</span><small>MULTIMARCAS</small></a>
    ...
    {mode === "home" ? <>
      ...
      <section className="home-showcase">
        <div className="home-showcase-heading"><div><p className="eyebrow">ESCOLHA O SEU CORRE</p><h2>Um estilo para cada momento.</h2></div><a href="/produtos">Ver catálogo <ArrowRight/></a></div>
